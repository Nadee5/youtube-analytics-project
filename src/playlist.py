...
class PlayList(GetYoutube):
    ...
    def __init__(self, playlist_id):
        ...
        self.playlist_info = self.youtube.playlists().list(id=playlist_id, part='snippet,contentDetails', maxResults=50).execute()
    ...
    def show_best_video(self):
        ...
        best_video_link = 'https://youtu.be/' + best_video_id
